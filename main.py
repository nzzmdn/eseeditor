...
win = QWidget()
win.resize(800, 600)
win.setWindowTitle('изи эдитор')
Ib_image = QLabel('Картиночка')
btn_dir = QPushButton('Папочка')
Iw_files = QListWidget()

btn_left = QPushButton('Лефт')
btn_right = QPushButton('Райгхт')
btn_flip = QPushButton('Мирор')
btn_sharp = QPushButton('Резкий?')
btn_bw = QPushButton('Nigga/White')
